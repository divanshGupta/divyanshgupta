...
export const projects: Project[] = [
  {
    ...
    keywords: ["Next.js", "Tailwind CSS", "GSAP", "Motion", "Lenis", "Vercel"],
    summary: [
    ...
    videoUrl: "/videos/jazminwong-cover.webm",
  ...
  },
  {
    ...
    summary: [
      ...
      "techhouse coaching and mentoring community. The focus was  ",
      "on creating a visually striking and intuitive user  ",
      "experience to optimize visitor-to-paid-member conversion.",
    ],
    year: 2024,
    backgroundImageUrl:
      "https://images.unsplash.com/photo-1481414981591-5732874c7193?q=80&w=3273&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    videoUrl: "/videos/kickbass-cover.webm",
